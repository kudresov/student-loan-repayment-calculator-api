  ...
  describe('1000£ debt', function(){
    ...
    describe('calculate interest for Jan-2011', function(){
      ...
      it('should be 1.25£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Jan-2011'), 1000);
    ...
    describe('calculate interest for Jan-2010', function(){
      ...
      it('should be 0£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Jan-2010'), 1000);
    ...
    describe('calculate interest for Aug-2010', function(){
      ...
      it('should be 0£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Aug-2010'), 1000);
        result.should.equal(0);
      });
    });
    ...
    describe('calculate interest April-2011', function(){
      ...
      it('should be 1.25£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('April-2011'), 1000);
        result.should.equal(1.25);
      });
    });
    ...
    describe('calculate interest Sep-2008', function(){
      ...
      it('should be 3.17£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Sep-2008'), 1000);
    ...
    describe('calculate interest Dec-2008', function(){
      ...
      it('should be 2.5£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Dec-2008'), 1000);
    ...
    describe('calculate interest Jan-2009', function(){
      ...
      it('should be 2.08£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Jan-2009'), 1000);
    ...
    describe('calculate interest Feb-2009', function(){
      ...
      it('should be 1.67£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Feb-2009'), 1000);
    ...
    describe('calculate interest March-2009', function(){
      ...
      it('should be 1.25£', function(){
        var result = interestCalculator.calculateInterestForMonth(moment('Mar-2009'), 1000);
        result.should.equal(1.25);
      });
    });
